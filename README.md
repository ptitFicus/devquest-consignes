...
2. Écrivez un test qui construit un groupe, fait des quêtes et vérifie que le nombre d'épée affichée à la fin de partie correspond bien aux quêtes qui ont été réussies (pour vous faiciliter la vie, vous pouvez fixer la seed, mais c'est possible sans).
...
- Supprimer vos fichiers hars puis relancez les tests pour en générer de nouveaux avec ce header supplémentaire.
